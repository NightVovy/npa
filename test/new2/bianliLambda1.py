...
for combo in results:
    print(f"p00={combo[0]:.1f}, p01={combo[1]:.1f}, p10={combo[2]:.1f}, p11={combo[3]:.1f}, beta2={combo[4]:.2f}, theta={combo[5]:.2f}, "
          f"lambda={combo[6]:.4f}, alpha={combo[7]:.4f}, lhs={combo[8]:.4f}, lhv={combo[9]:.4f}, "
          f"lambdaLessThanLhs={combo[10]}, lambdaLessThanLhv={combo[11]}, lhs-lambda={combo[12]}, lhv-lambda={combo[13]}")
